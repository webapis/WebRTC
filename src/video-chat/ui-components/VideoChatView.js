  ...
  return (
    <div className="video-chat-view">
        ...
        <div className="remote-media">
          {connected && (
            <DisplayMediaStream
              name={target}
              style={{ backgroundColor: 'blue' }}
              width={remoteStreamSize.width}
              height={remoteStreamSize.height}
      ...
      <div className="button-container">
        ...
        {answerBtnVisible && (
          <button type="button" style={style.btn} onClick={sendAnswer}>
            Answer
          </button>
        )}
        {declineBtnVisible && (
          <button type="button" style={style.btn} onClick={sendDecline}>
            Decline
          </button>
        )}
        {endBtnVisible && (
          <button type="button" style={style.btn} onClick={sendEnd}>
            End
          </button>
        )}
        {ignoreBtnVisible && (
          <button type="button" style={style.btn} onClick={sendIgnore}>
            Ignore
          </button>
        )}
        {cancellBtnVisible && (
          <button type="button" style={style.btn} onClick={sendCancel}>
            Cancel
          </button>
        )}
      </div>
